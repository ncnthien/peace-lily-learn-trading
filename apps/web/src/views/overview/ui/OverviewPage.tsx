...
import { useCandles, useSignal, useSrLevels } from '@/entities/market';
import { usePositionBoxes } from '@/entities/position-box';
import { useChartSettings } from '@/entities/setting';
