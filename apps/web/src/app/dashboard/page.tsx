...
import { useAccountDashboard } from '@/hooks/use-dashboard';
        ...
        <div className="mx-auto max-w-6xl px-4 py-8">
          <header className="mb-6 flex flex-wrap items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <Link href="/"><Button variant="outline" size="sm">Signals</Button></Link>
              <Link href="/automation"><Button variant="outline" size="sm">Automation</Button></Link>
            </div>
            <AccountSelector />
          </header>
          <Card>
